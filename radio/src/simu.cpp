...
//Message_Type   _________ ID____Message_Handler_______
  ...
  FXMAPFUNC(SEL_LEFTBUTTONPRESS, 0, Open9xSim::onMouseDown),
  FXMAPFUNC(SEL_LEFTBUTTONRELEASE, 0, Open9xSim::onMouseUp),
  FXMAPFUNC(SEL_MOTION, 0, Open9xSim::onMouseMove),
};
...
long Open9xSim::onMouseDown(FXObject*,FXSelector,void*v)
{
  FXEvent * evt=(FXEvent*)v;
