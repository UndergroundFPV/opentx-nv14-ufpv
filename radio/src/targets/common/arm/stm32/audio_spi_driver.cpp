...
void audioSpiInit(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = AUDIO_SPI_SCK_GPIO_PIN | AUDIO_SPI_MISO_GPIO_PIN | AUDIO_SPI_MOSI_GPIO_PIN;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
  GPIO_Init(AUDIO_SPI_GPIO, &GPIO_InitStructure);
  ...
  GPIO_PinAFConfig(AUDIO_SPI_GPIO, AUDIO_SPI_SCK_GPIO_PinSource, AUDIO_SPI_GPIO_AF);
  GPIO_PinAFConfig(AUDIO_SPI_GPIO, AUDIO_SPI_MISO_GPIO_PinSource, AUDIO_SPI_GPIO_AF);
  GPIO_PinAFConfig(AUDIO_SPI_GPIO, AUDIO_SPI_MOSI_GPIO_PinSource, AUDIO_SPI_GPIO_AF);
...
#if defined(AUDIO_SHUTDOWN_GPIO_PIN)
