...
#define AUX_SERIAL_TX_GPIO_PIN              GPIO_Pin_5 // PD.05
#define AUX_SERIAL_RX_GPIO_PIN              GPIO_Pin_6 // PD.06
#define AUX_SERIAL_TX_GPIO_PinSource        GPIO_PinSource5
#define AUX_SERIAL_RX_GPIO_PinSource        GPIO_PinSource6
